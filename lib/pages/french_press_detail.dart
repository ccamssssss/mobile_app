...
class FrenchPressDetailPage extends StatefulWidget {
  @override
  _FrenchPressDetailPage createState() => _FrenchPressDetailPage();
}

class _FrenchPressDetailPage extends State<FrenchPressDetailPage> {
            ...
            children: [
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        radius: 70,
                        backgroundImage: AssetImage('assets/french_press.png'),
                      ),
                    ),
                    SizedBox(height: 10),
                    const Text(
              ...
              Container(
                ...
                child: const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('• Coffee Beans (coarse grind)'),
                    Text(
                ...
                child: Container(
                  ...
                  child: const Column(
                    ...
                    children: [
                      Text('• French Press'),
                      Text(
                          '• Coffee Grinder (if you`re grinding your own beans)'),
                      Text('• Kettle'),
                      Text('• Timer'),
                    ],
                  ),
  ...
  String _getInstruction(int step) {
    switch (step) {
      case 1:
        return 'Grind the Coffee - Use a coarse grind, similar to sea salt. Measure about 1-2 tablespoons of coffee per 6 ounces of water.';
      case 2:
        return 'Preheat the French Press - Pour hot water into the French Press to warm it up, then pour it out.';
      case 3:
        return 'Add Coffee Grounds - Place the ground coffee into the French Press.';
      case 4:
        return 'Add Hot Water - Pour in hot water (just below boiling) over the coffee grounds, ensuring all the grounds are saturated.';
      case 5:
        return 'Stir - Gently stir the mixture to ensure even brewing.';
      case 6:
        return 'Enjoy brewing!';
      default:
        return '';
    }
  }
  ...
  String _getInstructionImage(int step) {
    switch (step) {
      case 1:
        return 'assets/instructions/fstep1.png';
      case 2:
        return 'assets/instructions/fstep2.png';
      case 3:
        return 'assets/instructions/fstep3.png';
      case 4:
        return 'assets/instructions/fstep4.png';
      case 5:
        return 'assets/instructions/fstep5.png';
      case 6:
        return 'assets/instructions/fstep6.png';
      default:
        return '';
    }
  }
